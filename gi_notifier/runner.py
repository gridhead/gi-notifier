...
from . import config
from .handler.chat_handler import handle_bot_added
from .handler.command_handler import handel_resinplan, handle_start
...
async def runner():
    ...
    application.add_handler(CommandHandler("ResinPlan", handel_resinplan))
